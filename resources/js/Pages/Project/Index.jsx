                            ...
                            <table className='w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400'>
                                ...
                                {projects.data.map(project => (
                                    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
                                        <th className='p-3 py-2'>{project.id}</th>
                                        <td className='p-3 py-2'>
                                            <img src={project.image_path} alt="" style={{ width: 60 }}/>
                                        </td>
                                        <td className='p-3 py-2'>{project.name}</td>
                                        <td className='p-3 py-2'>{project.status}</td>
                                        <td className='p-3 py-2 text-nowrap'>{project.created_at}</td>
                                        <td className='p-3 py-2 text-nowrap'>{project.due_date}</td>
                                        <td className='p-3 py-2'>{project.createdBy.name}</td>
                                        <td className='p-3 py-2'>
